      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <table class="table">
              <thead>
                <th>Nombre Pasantía</th>
                <th>Director Pasantía</th>
                <th>Coordinador Externo</th>
              </thead>
              <tbody>
                <td>{{ucfirst($opcion_grados[0]->descripcion)}}</td>
                <td>{{ucwords($director[0]->name_director)}}</td>
                @if(empty($externo[0]->nombre_entidad))
                  <td>No Registra</td>
                @else
                  <td>{{ucfirst($externo[0]->nombre_entidad)}}</td>
                @endif
              </tbody>
            </table>
            <table class="table">
              <thead>
                <th>Entidad</th>
                <th><center>Entrega Informe 1</center></th>
                <th><center>Entrega Final</center></th>
                <th><center>Concepto</center></th>
                <th><center>Carta Director</center></th>
                <th><center>Carta Corrdinador</center></th>
              ...
              <tbody>
                ...
                @endif
                  ...
                  <td><center>{{$opcion_grados[0]->fecha_entrega_2}}- Acta: {{$opcion_grados[0]->numero_acta_3}}</center></td>
                      @if($opcion_grados[0]->concepto_2=='ap')
                      <td><center>Aprobado</center></td>
                      @endif
                      @if($opcion_grados[0]->concepto_2=='aa')
                      <td><center>Apr. con Ajustes</center></td>
                      @endif
                      @if($opcion_grados[0]->concepto_2=='na')
                  ...
                  <td><center>{{$opcion_grados[0]->carta_coordinador}}</center></td>
                      ...
                      <td><center>Apr. con Ajustes</center></td>
                      @endif
                      @if($opcion_grados[0]->evaluacion=='na')
                      <td><center>No Aprobado</center></td>
                      @endif
                      @if($opcion_grados[0]->evaluacion=='me')
                      <td><center>Meritoria</center></td>
                      @endif
                      @if($opcion_grados[0]->evaluacion=='la')
                      <td><center>Laureada</center></td>
                      @endif
