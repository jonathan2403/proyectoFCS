...
class Proyecto extends Model
{
    ...
    protected $fillable = ['titulo_proyecto', 'tema_central', 'id_red_conocimiento', 'tipo', 'tipo_proyecto',
                            'fecha_inicio', 'numero_acta', 'fecha_avance1', 'fecha_avance2', 'fecha_avance3',
                             ...
                             'ejecutado', 'id_director', 'beneficiados_administrativos', 'beneficiados_estudiantes',
    ...
    public function investigador_principal(){
      return $this->belongsTo('FCS\Profesor', 'id_director');
    }

    public static $reglas = array(
      'titulo_proyecto' => "required|max:100|regex:/^[A-Za-z1-9ñÑáéíóúÁÉÍÓÚ\! '\@\.:\(\)]+$/",
