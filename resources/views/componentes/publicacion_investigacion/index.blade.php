				...
				<div class="box">
					...
					<div class="box-body">
						<div class="row form-group">
							<div class="col-md-3">
								<a href="{!! URL('publicacion-investigacion/create') !!}" class="btn btn-success"><i class="fa fa-plus"></i> Nueva Publicación</a>
							</div>
						</div>
								...
								<tbody>
									@foreach($publicaciones as $publicacion)
										...
										<td>{!!link_to_route('publicacion-investigacion.show', ucfirst($publicacion->descripcion),$parameters=$publicacion->id)!!}</td>
											...
											<td><center>{!! link_to_route('publicacion-investigacion.edit', 'Editar', $publicacion->id, ['class'=>'btn btn-warning btn-sm']) !!}|<a class="btn btn-danger btn-sm" href="{{URL::to('publicacion/investigacion/eliminar/'.$publicacion->id)}}">Borrar</a>
											</center></td>
										</tr>
									@endforeach
								</tbody>
